/**
 * Product Notes for WooCommerce - Admin JS
 *
 * @version 2.5.1
 * @since   2.0.0
 *
	...
	function alg_wc_pn_get_wp_editor_settings() {
		return {
			tinymce: {
				...
				toolbar1:
					"formatselect bold italic bullist numlist blockquote alignleft aligncenter alignright link wp_more fullscreen",
			},
			quicktags: true,
			mediaButtons: true,
		};
