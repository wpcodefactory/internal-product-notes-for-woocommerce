...
if ( ! class_exists( 'Alg_WC_PN_Formatter' ) ) :

	/**
	 * Alg_WC_PN_Formatter class.
	 *
	 * @version 3.2.0
	 * @since   2.7.0
	 */
	class Alg_WC_PN_Formatter {
		 ...
		 */
		public function get_default_args( $type ) {
			switch ( $type ) {
				case 'wpo_wcpdf':
					return array(
						'do_esc_html'    => 'yes',
		 ...
		 */
		public function get_args( $private_or_public, $type ) {
		 ...
		 */
		public function format_notes( $notes, $args = array() ) {
			$args  = array_merge(
				array(
					'do_esc_html'    => true,
					'do_shortcode'   => false,
...
return new Alg_WC_PN_Formatter();
